#ifndef BABEL_CHROME_BABELBROWSERWINDOWLOCALDROPACTIONS_H_
#define BABEL_CHROME_BABELBROWSERWINDOWLOCALDROPACTIONS_H_
 ...
 */
@interface BabelBrowserWindowLocalDropActions : NSObject
