#ifndef BABEL_CHROME_BABELBROWSERWINDOWGROUPSANDTABSACTIONS_H_
#define BABEL_CHROME_BABELBROWSERWINDOWGROUPSANDTABSACTIONS_H_
 ...
 */
@interface BabelBrowserWindowGroupsAndTabsActions : NSObject
