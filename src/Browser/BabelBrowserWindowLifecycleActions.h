#ifndef BABEL_CHROME_BABELBROWSERWINDOWLIFECYCLEACTIONS_H_
#define BABEL_CHROME_BABELBROWSERWINDOWLIFECYCLEACTIONS_H_
 ...
 */
@interface BabelBrowserWindowLifecycleActions : NSObject
