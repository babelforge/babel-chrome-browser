...
- (NSString*)internalPageHTMLWithTitle:(NSString*)title body:(NSString*)body {
  ...
  return [NSString stringWithFormat:
      @"<!doctype html><html><head><meta charset='utf-8'>"
       ...
       ".moduleStatusRow{grid-column:1 / -1;display:flex;align-items:center;gap:6px;flex-wrap:wrap;min-width:0;}"
       ".statusBadge{display:inline-flex!important;align-items:center;justify-content:center;min-width:0;max-width:180px;height:20px;padding:0 8px;border-radius:999px;font-size:11px;font-weight:800;line-height:20px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;border:1px solid transparent;}"
       ".statusReady{background:#e8f7ee;border-color:#a6dfba;color:#116329;}.statusRunning{background:#eaf2ff;border-color:#accbff;color:#174ea6;}"
       ".statusWarning{background:#fff7df;border-color:#efd27a;color:#785200;}.statusFailed{background:#fff0f0;border-color:#f1b6b6;color:#9b1c1c;}"
       ".statusIdle,.statusUnknown{background:#f1f5f9;border-color:#d6dde6;color:#526171;}"
       ...
       ".detailsActions{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-top:12px;}"
       ".runtimeLog{font:12px ui-monospace,SFMono-Regular,Menlo,monospace;white-space:pre-wrap;word-break:break-word;background:#101820;color:#dbeafe;border-radius:8px;padding:12px;max-height:320px;overflow:auto;}"
       ...
       "body.dark .statusReady{background:#143522;border-color:#2c7a45;color:#9ee6b1;}body.dark .statusRunning{background:#172c49;border-color:#2f66b1;color:#b9d7ff;}"
       "body.dark .statusWarning{background:#3d3112;border-color:#80631d;color:#ffe08a;}body.dark .statusFailed{background:#3b1c21;border-color:#89404a;color:#ffb8c1;}"
       "body.dark .statusIdle,body.dark .statusUnknown{background:#252d36;border-color:#3e4854;color:#b8c4d0;}"
