#ifndef BABEL_CHROME_BABELBROWSERWINDOWBROWSERATTACHMENTACTIONS_H_
#define BABEL_CHROME_BABELBROWSERWINDOWBROWSERATTACHMENTACTIONS_H_
 ...
 */
@interface BabelBrowserWindowBrowserAttachmentActions : NSObject
