#ifndef BABEL_CHROME_BABELBROWSERWINDOWADDRESSANDSUGGESTIONSACTIONS_H_
#define BABEL_CHROME_BABELBROWSERWINDOWADDRESSANDSUGGESTIONSACTIONS_H_
 ...
 */
@interface BabelBrowserWindowAddressAndSuggestionsActions : NSObject
