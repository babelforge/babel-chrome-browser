#ifndef BABEL_CHROME_BABELBROWSERWINDOWINTERNALPAGESACTIONS_H_
#define BABEL_CHROME_BABELBROWSERWINDOWINTERNALPAGESACTIONS_H_
 ...
 */
@interface BabelBrowserWindowInternalPagesActions : NSObject
