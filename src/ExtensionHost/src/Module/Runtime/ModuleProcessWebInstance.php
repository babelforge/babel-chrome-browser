...
/**
 * Tracks one running process-web module instance.
 */
final class ModuleProcessWebInstance
{
     ...
     * @param string                $baseUrl       the process base URL
     ...
     * @param string                $readyUrl      the resolved readiness URL
    ...
    public function __construct(
        ...
        public readonly string $readyUrl,
